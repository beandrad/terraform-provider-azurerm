...
// func (client CustomJitNetworkAccessPoliciesClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, jitNetworkAccessPolicyName string, ascLocation string, body JitNetworkAccessPolicy) (*http.Request, error) {
